...
Wird ein Smart Home System lokal betrieben und die Fernsteuerung über einen eigenen \ac{VPN} realisiert können Angriffe aus dem Internet weitgehend ausgeschlossen werden.
...
% asr input only for not critical systems
