...
Die \textit{Feldbusebene}, die \textit{Automationsebene} und die \textit{Leitebene}. \myfootcite[Vgl.][59]{aschendorf14}
...
Die Feldbusebene besteht aus sämtlichen eingebauten Systemkomponenten, also Gateways, welche verschiedene Systeme verbinden, Sensoren, welche z.B. Temperatur und Luftfeuchtigkeit überwachen und Aktoren, welche u.a. z.B. Glühbirnen sein können.
...
\subsubsection{Automationsebene}

Automatisierungen, welche nicht bereits in Geräten, die sowohl Sensoren, als auch Aktoren beinhalten, werden in der Automationsebene implementiert.
