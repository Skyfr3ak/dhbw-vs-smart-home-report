...
Bei Betrachtung des geschätzten Marktvolumens von 39,68 Mrd. USD nach Mordor Intelligence \myfootcite[Vgl.][]{market_mi}, ist eine klare optimistische Tendenz zu erkennen.
...
\subsubsection{\textbf{TODO} Smart Home Geräte} % TODO better title

% how does the business model work?

% sell product + integration or cloud service
...
% is huge due to google home and alexa (and apple home haha funny xd)

\subsubsection{\textbf{TODO} Komplettsystem-Anbieter}

% how does the business model work?

% sell products + platform + support
...
\subsubsection{\textbf{TODO} Plattform}
