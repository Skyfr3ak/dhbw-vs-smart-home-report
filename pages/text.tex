...
% TODO why did we choose those products?
...
Unter der Marke HomeMatic IP vertreibt die deutsche Aktiengesellschaft eQ-3 eine Smart Home Komplettlösung, welche die Bereiche Heizung und Klima, Sicherheit und Alarm, Licht und Schatten, sowie Wetter und Umwelt bedient.\myfootcite[Vgl.][19f]{eq3_homematicip_docs}
...
Über die HomeMatic IP Smartphone App kann das Gesamtsystem auch manuell gesteuert werden.
...
\myfootcite[Vgl.][22-25]{eq3_homematicip_docs}

%\glqq Für den Betrieb ist der Homematic IP Access Point in Verbindung mit der Homematic IP App [...], die Homematic Zentrale CCU2 oder eine geeignete Partnerlösung notwendig.\grqq \myfootcite[18]{eq3_homematicip_docs}

% 868mhz p18
%

%\myfootcite[Vgl.][]{eq3_homematicip_docs}
%\myfootcite[Vgl.][]{eq3_faq}

% pros

% 868 störfrei p21
% claim: anonymous! deutscher datenschutz p18 p24
% bidirektional p21
